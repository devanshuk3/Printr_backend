...
router.post('/register', [
  ...
  try {
    ...
    const allFields = [
      ...
      { col: 'bw_price_single',   val: data.bw_price_single || 0 },
      { col: 'bw_price_2_to_5',   val: data.bw_price_2_to_5 || 0 },
      { col: 'bw_price_6_to_9',   val: data.bw_price_6_to_9 || 0 },
      { col: 'bw_price_10_plus',  val: data.bw_price_10_plus || 0 },
      { col: 'color_price_single',  val: data.color_price_single || 0 },
...
router.put('/settings', [
  ...
  try {
    ...
    if (bw_price_single !== undefined) {
      updates.push(`bw_price_single = $${paramCounter++}`);
      values.push(bw_price_single);
    }
    if (bw_price_2_to_5 !== undefined) {
      updates.push(`bw_price_2_to_5 = $${paramCounter++}`);
      values.push(bw_price_2_to_5);
    }
    if (bw_price_6_to_9 !== undefined) {
      updates.push(`bw_price_6_to_9 = $${paramCounter++}`);
      values.push(bw_price_6_to_9);
    }
    if (bw_price_10_plus !== undefined) {
      updates.push(`bw_price_10_plus = $${paramCounter++}`);
      values.push(bw_price_10_plus);
    }
    if (color_price_single !== undefined) {
      updates.push(`color_price_single = $${paramCounter++}`);
      values.push(color_price_single);
    }
    if (color_price_2_to_5 !== undefined) {
      updates.push(`color_price_2_to_5 = $${paramCounter++}`);
      values.push(color_price_2_to_5);
    }
    if (color_price_6_to_9 !== undefined) {
      updates.push(`color_price_6_to_9 = $${paramCounter++}`);
      values.push(color_price_6_to_9);
    }
