...
const initDb = async () => {
  ...
  const createVendorTableQuery = `
    CREATE TABLE IF NOT EXISTS vendors (
      ...
      a4_price DECIMAL(10, 2) NOT NULL DEFAULT 0,
      a3_price DECIMAL(10, 2) NOT NULL DEFAULT 0,
      letter_price DECIMAL(10, 2) NOT NULL DEFAULT 0,
      legal_price DECIMAL(10, 2) NOT NULL DEFAULT 0,
  ...
  try {
    ...
    const migrations = [
      ...
      'ALTER TABLE vendors ADD COLUMN IF NOT EXISTS a4_price DECIMAL(10, 2) NOT NULL DEFAULT 0',
      'ALTER TABLE vendors ADD COLUMN IF NOT EXISTS a3_price DECIMAL(10, 2) NOT NULL DEFAULT 0',
      'ALTER TABLE vendors ADD COLUMN IF NOT EXISTS letter_price DECIMAL(10, 2) NOT NULL DEFAULT 0',
      'ALTER TABLE vendors ADD COLUMN IF NOT EXISTS legal_price DECIMAL(10, 2) NOT NULL DEFAULT 0',
